    ...
    return (
        <div className="initial-overlay-dialog">
            <div className="dialog-content">
                ...
                <p>Si deseas eliminar a una persona directamente desde el lienzo, realiza un doble clic sobre la persona (en caso de un navegador de escritorio) o un toque (en caso de un navegador móvil). Aparecerá un menú en el que debes seleccionar la opción de "Eliminar".</p>
